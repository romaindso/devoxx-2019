...
var scheduleDeferredCallback = unstable_scheduleCallback;
var shouldYield = unstable_shouldYield;
var cancelDeferredCallback = unstable_cancelCallback;
...
var noTimeout = -1;
var schedulePassiveEffects = scheduleDeferredCallback;
var cancelPassiveEffects = cancelDeferredCallback;
...
function updateDehydratedSuspenseComponent(current, workInProgress, renderExpirationTime) {
  ...
  var hasContextChanged$$1 = current.childExpirationTime >= renderExpirationTime;
  var suspenseInstance = current.stateNode;
  if (didReceiveUpdate || hasContextChanged$$1 || isSuspenseInstanceFallback(suspenseInstance)) {
    ...
    registerSuspenseInstanceRetry(suspenseInstance, retryTimedOutBoundary.bind(null, current));
    return null;
  } else {
    // This is the first attempt.
...
function performWork(minExpirationTime, isYieldy) {
  ...
  if (isYieldy) {
    ...
    while (nextFlushedRoot !== null && nextFlushedExpirationTime !== NoWork && minExpirationTime <= nextFlushedExpirationTime && !(shouldYield() && currentRendererTime > nextFlushedExpirationTime)) {
...
function scheduleRootUpdate(current$$1, element, expirationTime, callback) {
  {
    if (phase === 'render' && current$1 !== null && !didWarnAboutNestedUpdates) {
...
var base$2 = _class(node$2, {
	...
	_transform: function(){
		...
		skew.matrix = [transform$$2.xx.toFixed(4), transform$$2.xy.toFixed(4), transform$$2.yx.toFixed(4), transform$$2.yy.toFixed(4), 0, 0];
...
var group$2 = _class(node$2, container, {
	...
	_transform: function(){
		...
		this._activeTransform = container$$2 ? new transform(container$$2._activeTransform).transform(this) : this;
