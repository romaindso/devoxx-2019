...
},{"./cjs/scheduler.development.js":"../node_modules/scheduler/cjs/scheduler.development.js"}],"../vendor/react-cache.development.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
(function (global, factory) {
  (typeof exports === 'undefined' ? 'undefined' : (0, _typeof3.default)(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('scheduler')) : typeof define === 'function' && define.amd ? define(['exports', 'react', 'scheduler'], factory) : factory(global.ReactCache = {}, global.React, global.Scheduler);
})(undefined, function (exports, React, Scheduler) {
  'use strict';
...
},{"babel-runtime/helpers/typeof":"../node_modules/babel-runtime/helpers/typeof.js","react":"../vendor/react.development.js","scheduler":"../node_modules/scheduler/index.js"}],"../node_modules/stylis/stylis.min.js":[function(require,module,exports) {
var define;
...
var index = (0, _memoize2.default)(function (prop) {
...
exports.__DO_NOT_USE_OR_YOU_WILL_BE_HAUNTED_BY_SPOOKY_GHOSTS = exports.StyleSheetManager = exports.ServerStyleSheet = exports.withTheme = exports.ThemeProvider = exports.ThemeContext = exports.ThemeConsumer = exports.isStyledComponent = exports.createGlobalStyle = exports.keyframes = exports.css = undefined;

var _stylis = require('stylis/stylis.min');
...
function addUnitIfNeeded(name, value) {
  ...
  if (typeof value === 'number' && value !== 0 && !(name in _unitless2.default)) {
  ...
  if (isFunction(chunk)) {
    if (executionContext) {
      ...
      try {
        ...
        if ((0, _reactIs.isElement)(new chunk(executionContext))) {
          shouldThrow = true;
        }
      } catch (e) {
        /* */
...
var ThemeProvider = function (_Component) {
  ...
  function ThemeProvider(props) {
    ...
    _this.getContext = (0, _memoizeOne2.default)(_this.getContext.bind(_this));
  ...
  ThemeProvider.prototype.render = function render() {
    ...
    return _react2.default.createElement(ThemeContext.Consumer, null, this.renderInner);
  };

  ThemeProvider.prototype.renderInner = function renderInner(outerTheme) {
    var context = this.getContext(this.props.theme, outerTheme);

    return _react2.default.createElement(ThemeContext.Provider, { value: context }, _react2.default.Children.only(this.props.children));
  };
...
var StyleSheetManager = function (_Component) {
  ...
  function StyleSheetManager(props) {
    ...
    _this.getContext = (0, _memoizeOne2.default)(_this.getContext);
    return _this;
  }
  ...
  StyleSheetManager.prototype.render = function render() {
    ...
    return _react2.default.createElement(StyleSheetContext.Provider, { value: this.getContext(sheet, target) }, 'development' !== 'production' ? _react2.default.Children.only(children) : children);
  };
...
function createGlobalStyle(strings) {
  ...
  var GlobalStyleComponent = function (_React$Component) {
    ...
    GlobalStyleComponent.prototype.render = function render() {
      ...
      return _react2.default.createElement(StyleSheetConsumer, null, function (styleSheet) {
...
var withTheme = function (Component$$1) {
  var WithTheme = _react2.default.forwardRef(function (props, ref) {
    return _react2.default.createElement(ThemeConsumer, null, function (theme) {
      // $FlowFixMe
      ...
      return _react2.default.createElement(Component$$1, _extends({}, props, { theme: themeProp, ref: ref }));
    });
  });
...
},{"stylis/stylis.min":"../node_modules/stylis/stylis.min.js","stylis-rule-sheet":"../node_modules/stylis-rule-sheet/index.js","react":"../vendor/react.development.js","@emotion/unitless":"../node_modules/@emotion/unitless/dist/unitless.browser.esm.js","react-is":"../node_modules/react-is/index.js","memoize-one":"../node_modules/memoize-one/dist/memoize-one.esm.js","prop-types":"../node_modules/prop-types/index.js","react-dom":"../vendor/react-dom.development.js","@emotion/is-prop-valid":"../node_modules/@emotion/is-prop-valid/dist/is-prop-valid.browser.esm.js","process":"../node_modules/process/browser.js"}],"suspense-data/ui.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Todos = exports.Todo = exports.Title = exports.Container = undefined;
...
})(["background:#eb643b;color:white;font-size:32px;padding:10px;text-align:center;"]);

var Todo = exports.Todo = _styledComponents2.default.li.withConfig({
  displayName: "ui__Todo"
})(["list-style-type:none;background:white;color:#24a29a;padding:10px;font-size:24px;margin:0px 0px 5px;"]);

var Todos = exports.Todos = _styledComponents2.default.ul.withConfig({
  displayName: "ui__Todos"
})(["margin:0;padding:0px;"]);
},{"styled-components":"../node_modules/styled-components/dist/styled-components.browser.esm.js"}],"suspense-data/TodoList.js":[function(require,module,exports) {
"use strict";
...
},{"react":"../vendor/react.development.js","./ui":"suspense-data/ui.js"}],"common/ui.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.NavLink = exports.Nav = exports.Center = undefined;
...
},{"styled-components":"../node_modules/styled-components/dist/styled-components.browser.esm.js"}],"common/Loader.js":[function(require,module,exports) {
"use strict";
...
var Loader = function Loader(_ref) {
  ...
  return _react2.default.createElement(
    _ui.Center,
    null,
    _react2.default.createElement("img", { src: type, height: height })
  );
};

exports.default = Loader;
},{"react":"../vendor/react.development.js","./ui":"common/ui.js"}],"suspense-data/todos-data.js":[function(require,module,exports) {
"use strict";
...
exports.default = [{
  id: 1,
  text: "Write my first React talk"
}, {
  id: 2,
  text: "Open source some cool stuff at work"
}, {
  id: 3,
  text: "Start a new life in Montréal 🍁"
}, {
  id: 4,
  text: "Make jokes about AngularJS"
}, {
  id: 5,
  text: "Get more followers than my girlfriend 🙃"
}];
},{}],"assets/chocolatine.gif":[function(require,module,exports) {
module.exports = "/chocolatine.4b08c067.gif";
},{}],"suspense-data/App.js":[function(require,module,exports) {
"use strict";
...
var _Loader = require("../common/Loader");

var _Loader2 = _interopRequireDefault(_Loader);

var _todosData = require("./todos-data.js");

var _todosData2 = _interopRequireDefault(_todosData);

var _chocolatine = require("../assets/chocolatine.gif");

var _chocolatine2 = _interopRequireDefault(_chocolatine);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var TodosResource = (0, _reactCache.unstable_createResource)(function () {
  return new Promise(function (resolve) {
    setTimeout(function () {
      resolve(_todosData2.default);
    }, 2000);
  });
});

var Todos = function Todos() {
  var data = TodosResource.read();
  return _react2.default.createElement(_TodoList2.default, { todos: data });
};

var TodoListApp = function (_Component) {
  (0, _inherits3.default)(TodoListApp, _Component);

  function TodoListApp() {
    (0, _classCallCheck3.default)(this, TodoListApp);
    return (0, _possibleConstructorReturn3.default)(this, (TodoListApp.__proto__ || Object.getPrototypeOf(TodoListApp)).apply(this, arguments));
  }

  (0, _createClass3.default)(TodoListApp, [{
    key: "render",
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _react.Suspense,
          { maxDuration: 500, fallback: _react2.default.createElement(_Loader2.default, { type: _chocolatine2.default }) },
...
},{"babel-runtime/helpers/classCallCheck":"../node_modules/babel-runtime/helpers/classCallCheck.js","babel-runtime/helpers/createClass":"../node_modules/babel-runtime/helpers/createClass.js","babel-runtime/helpers/possibleConstructorReturn":"../node_modules/babel-runtime/helpers/possibleConstructorReturn.js","babel-runtime/helpers/inherits":"../node_modules/babel-runtime/helpers/inherits.js","react":"../vendor/react.development.js","react-cache":"../vendor/react-cache.development.js","./ui":"suspense-data/ui.js","./TodoList":"suspense-data/TodoList.js","../common/Loader":"common/Loader.js","./todos-data.js":"suspense-data/todos-data.js","../assets/chocolatine.gif":"assets/chocolatine.gif"}]},{},["suspense-data/App.js"], null)
//# sourceMappingURL=/App.49377f3e.map